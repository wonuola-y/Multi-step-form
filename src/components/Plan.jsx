        ...
        <div className="w-7/12 font-sans py-10 pl-24">
          ...
          <div className="flex flex-col">
            <div className="flex justify-between  my-10">
              <input type="checkbox" name="arcade" id="arcade" className="hidden"
              value={arcade === '$9/mo' ? 'monthly' : 'yearly'}
              
               />
              <div className="card flex flex-col border-off-white border-[1px] hover:border-[1px] hover:border-navy-blue border-solid w-3/12 rounded-lg px-4 py-5" onClick={()=>{
                setArcade(arc)
              }}>
