        ...
        <div className="w-7/12 font-sans py-10 pl-24">
          ...
          <form className="w-10/12 my-10">
            <div className=" font-sans flex flex-col my-5 ">
              <label className=" text-navy-blue font-bold my-3" htmlFor="name">
                Name
              </label>
              <input
            ...
            <div className="flex flex-col my-5">
              <label className="text-navy-blue font-bold my-3" htmlFor="email">
                Email Address
              </label>
              <input
            ...
            <div className="flex flex-col my-5">
              <label className="text-navy-blue font-bold my-3" htmlFor="phone">
                Phone Number
              </label>
              <input
                className=" font-sans p-5 border-[1px] border-navy-blue rounded-md"
          ...
          <Link to='/Plan'>
            <button className="rounded  bg-navy-blue text-white py-2 px-4">
              Next step
            </button>
          </Link>
        </div>
